...
4. The next time, Unison composes its own fresh expression of what it was taught — measured: **17% → 67% judged-good across three teaching rounds, climbing.** It learned *from* the correction; it does not replay it.
